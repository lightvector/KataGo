...
cur_layer = conv_only_block("conv1",cur_layer,diam=5,in_channels=input_num_channels,out_channels=128)

#Residual Convolutional Block 1---------------------------------------------------------------------------------
cur_layer = res_conv_block("rconv1",cur_layer,diam=3,main_channels=128,mid_channels=128)

#Residual Convolutional Block 2---------------------------------------------------------------------------------
cur_layer = res_conv_block("rconv2",cur_layer,diam=3,main_channels=128,mid_channels=128)
...
p1_num_channels = 48
p1_intermediate_conv = conv_only_block("p1/intermediate_conv",p0_layer,diam=3,in_channels=128,out_channels=p1_num_channels)
...
g1_num_channels = 16
g1_layer = conv_block("g1",p0_layer,diam=3,in_channels=128,out_channels=g1_num_channels)
