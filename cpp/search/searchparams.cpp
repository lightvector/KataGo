...
SearchParams::SearchParams()
  :winLossUtilityFactor(1.0),
   ...
   policyBiasReplyFactor(0.0),
   policyBiasDiscountSelf(true),
...
SearchParams SearchParams::forTestsV2() {
  ...
  params.policyBiasReplyFactor = 0.0;
  params.policyBiasDiscountSelf = true;
  return params;
}
...
void SearchParams::printParams(std::ostream& out) {
  ...
  PRINTPARAM(policyBiasReplyFactor);
  PRINTPARAM(policyBiasDiscountSelf);
