...
GameRunner::GameRunner(ConfigParser& cfg, FancyModes fModes, Logger& logger)
...
GameRunner::GameRunner(ConfigParser& cfg, const string& gameInitRandSeed, FancyModes fModes, Logger& logger)
  :logSearchInfo(),logMoves(),maxMovesPerGame(),clearBotBeforeSearch(),
   fancyModes(fModes),
   gameInit(NULL)
{
