...
Result build(
  ...
  // order, with InputMeta between InputGlobal and InputMask for HumanSL nets) fixes it. This is NOT
  // the graph's first-reference order; it is an empirical, OpenVINO-EP-specific requirement.
