...
namespace NNInputs {
  ...
  constexpr int DOTS_FEATURE_SPATIAL_PLAYER = 1; // 1
  constexpr int DOTS_FEATURE_SPATIAL_PLAYER_OPP = 2; // 2
  constexpr int DOTS_FEATURE_SPATIAL_PLAYER_CAPTURES = 3; // (3,4,5)
  constexpr int DOTS_FEATURE_SPATIAL_PLAYER_SURROUNDINGS = 4; // (3,4,5)
  constexpr int DOTS_FEATURE_SPATIAL_PLAYER_OPP_CAPTURES = 5; // (3,4,5)
  constexpr int DOTS_FEATURE_SPATIAL_PLAYER_OPP_SURROUNDINGS = 6; // (3,4,5)
  constexpr int DOTS_FEATURE_SPATIAL_DEAD_DOTS = 7;  // Needed for more correct score calculation
  constexpr int DOTS_FEATURE_SPATIAL_GROUNDED = 8; // Analogue of territory (18,19)
  constexpr int DOTS_FEATURE_SPATIAL_LAST_MOVE_0 = 9; // 9
  constexpr int DOTS_FEATURE_SPATIAL_LAST_MOVE_1 = 10; // 10
  constexpr int DOTS_FEATURE_SPATIAL_LAST_MOVE_2 = 11; // 11
  constexpr int DOTS_FEATURE_SPATIAL_LAST_MOVE_3 = 12; // 12
  constexpr int DOTS_FEATURE_SPATIAL_LAST_MOVE_4 = 13; // 13
  constexpr int DOTS_FEATURE_SPATIAL_LADDER_CAPTURED = 14; // 14, TODO: implement later
  constexpr int DOTS_FEATURE_SPATIAL_LADDER_CAPTURED_PREVIOUS = 15; // 15, TODO: implement later
  constexpr int DOTS_FEATURE_SPATIAL_LADDER_CAPTURED_PREVIOUS_2 = 16; // 16, TODO: implement later
  constexpr int DOTS_FEATURE_SPATIAL_LADDER_WORKING_MOVES = 17; // 17, TODO: implement later
