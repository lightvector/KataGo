  ...
  auto loadLatestNeuralNet =
    ...
    NNEvaluator* testNNEval;
    {
      vector<NNEvaluator*> nnEvals =
        Setup::initializeNNEvaluators({testModelName},{testModelFile},cfg,logger,rand,maxConcurrentEvals,debugSkipNeuralNetDefaultTest,false);
    ...
    {
      vector<NNEvaluator*> nnEvals =
        Setup::initializeNNEvaluators({acceptedModelName},{acceptedModelFile},cfg,logger,rand,maxConcurrentEvals,debugSkipNeuralNetDefaultAccepted,false);
      assert(nnEvals.size() == 1);
