...
using fmha_block_tile = ck_tile::sequence<64, 64, 16, 32, 32, 32>;
...
using trait = fmha_fwd_traits_<32, FmhaFwdFp16, false,64, 64, 16, 32, 32, 32, true,
...
float fmha_fwd_<trait, ck_tile::gfx11_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d32_fp16_batch_b64x64x16x32x32x32_r4x1x1_r4x1x1_w16x16x16_w16x16x16_qr_hpad_vr_psskddv_nlogits_bias_nmask_nlse_ndropout_nskip_nqscale_ntrload_nsink" << std::flush;
