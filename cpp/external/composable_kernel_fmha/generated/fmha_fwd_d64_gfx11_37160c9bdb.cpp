...
float fmha_fwd_<trait, ck_tile::gfx11_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d64_fp16_batch_b128x64x32x64x32x64_r8x1x1_r8x1x1_w16x16x16_w16x16x16_qr_vr_pssk_nlogits_bias_nmask_nlse_ndropout_nskip_nqscale_ntrload_nsink" << std::flush;
