...
#if defined(__HIP_DEVICE_COMPILE__) &&     (defined(__gfx1100__) || defined(__gfx1101__) || defined(__gfx1102__) ||      defined(__gfx1103__) || defined(__gfx1150__) || defined(__gfx1151__) ||      defined(__gfx1152__) || defined(__gfx1153__) || defined(__gfx11_generic__) ||      defined(__gfx1200__) || defined(__gfx1201__) || defined(__gfx12_generic__))
...
#if !defined(__HIP_DEVICE_COMPILE__) || (defined(__gfx11__) && !defined(__gfx115__))

using fmha_dtype = FmhaFwdFp16;

using fmha_block_tile = ck_tile::sequence<64, 64, 32, 64, 32, 64>;
...
using fmha_pipeline = ck_tile::BlockFmhaPipelineQRKSVSHpad<
...
using trait = fmha_fwd_traits_<64, FmhaFwdFp16, false,64, 64, 32, 64, 32, 64, true,
                        ck_tile::BlockFmhaPipelineEnum::QRKSVS_HPAD, false, fmha_mask, ck_tile::BlockAttentionBiasEnum::ELEMENTWISE_BIAS, false, false, ck_tile::BlockAttentionQuantScaleEnum::NO_SCALE, true, true, true, true, false, false, false>;

template<>
float fmha_fwd_<trait, ck_tile::gfx11_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    using k_ = fmha_kernel;
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d64_fp16_batch_b64x64x32x64x32x64_r4x1x1_r4x1x1_w16x16x16_w16x16x16_qr_hpad_vr_psskddv_nlogits_bias_nmask_nlse_ndropout_nskip_nqscale_ntrload_nsink" << std::flush;
    auto [kargs, grids] = fmha_fwd_create_kargs_and_grids<k_>(a);
    const dim3 blocks                      = k_::BlockSize();
    constexpr ck_tile::index_t kBlockPerCu = k_::kBlockPerCu;
    return ck_tile::launch_kernel(s, ck_tile::make_kernel<kBlockPerCu, ck_tile::gfx11_t>(k_{}, grids, blocks, 0, kargs));
}

#endif // !defined(__HIP_DEVICE_COMPILE__) || (defined(__gfx11__) && !defined(__gfx115__))
