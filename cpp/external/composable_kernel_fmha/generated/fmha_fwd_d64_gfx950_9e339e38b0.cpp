...
using trait = fmha_fwd_traits_<64, FmhaFwdFp16, false,16, 32, 64, 64, 32, 64, true,
                        ck_tile::BlockFmhaPipelineEnum::QRKSVS_ASYNC_TRLOAD, false, fmha_mask, ck_tile::BlockAttentionBiasEnum::NO_BIAS, false, false, ck_tile::BlockAttentionQuantScaleEnum::NO_SCALE, true, true, false, false, true, false, false>;
...
float fmha_fwd_<trait, ck_tile::gfx950_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d64_fp16_batch_b16x32x64x64x32x64_r1x1x1_r1x1x1_w16x16x32_w16x16x32_qr_async_trload_vr_pssk_nlogits_nbias_nmask_nlse_ndropout_nskip_nqscale_trload_nsink" << std::flush;
