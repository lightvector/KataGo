...
using fmha_block_tile = ck_tile::sequence<128, 64, 16, 32, 32, 32>;
...
using trait = fmha_fwd_traits_<32, FmhaFwdFp16, false,128, 64, 16, 32, 32, 32, true,
                        ck_tile::BlockFmhaPipelineEnum::QRKSVS, false, fmha_mask, ck_tile::BlockAttentionBiasEnum::ELEMENTWISE_BIAS, false, false, ck_tile::BlockAttentionQuantScaleEnum::NO_SCALE, false, false, false, false, false, false, false>;
...
float fmha_fwd_<trait, ck_tile::gfx950_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d32_fp16_batch_b128x64x16x32x32x32_r4x1x1_r4x1x1_w32x32x16_w32x32x16_qr_vr_npad_nlogits_bias_nmask_nlse_ndropout_nskip_nqscale_ntrload_nsink" << std::flush;
