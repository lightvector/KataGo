...
using trait = fmha_fwd_traits_<64, FmhaFwdFp16, false,64, 64, 32, 64, 32, 64, true,
                        ck_tile::BlockFmhaPipelineEnum::QRKSVS_HPAD, false, fmha_mask, ck_tile::BlockAttentionBiasEnum::NO_BIAS, false, false, ck_tile::BlockAttentionQuantScaleEnum::NO_SCALE, true, true, true, true, false, false, false>;
...
float fmha_fwd_<trait, ck_tile::gfx11_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d64_fp16_batch_b64x64x32x64x32x64_r4x1x1_r4x1x1_w16x16x16_w16x16x16_qr_hpad_vr_psskddv_nlogits_nbias_nmask_nlse_ndropout_nskip_nqscale_ntrload_nsink" << std::flush;
