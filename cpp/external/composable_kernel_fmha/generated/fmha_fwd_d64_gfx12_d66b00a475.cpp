...
template<>
float fmha_fwd_<trait, ck_tile::gfx12_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    return ck_tile::launch_kernel(s, ck_tile::make_kernel<kBlockPerCu, ck_tile::gfx12_t>(k_{}, grids, blocks, 0, kargs));
}

#endif // !defined(__HIP_DEVICE_COMPILE__) || (defined(__gfx12__))
