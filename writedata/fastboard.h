...
static inline Color getColorOfPlayer(Player p)
{return p == P_BLACK ? C_BLACK : C_WHITE;}
static inline Player getEnemy(Player p)
{return p == P_BLACK ? P_WHITE : P_BLACK;}
static inline Color getEnemyColor(Color c)
{return c ^ 3;}
...
struct FastBoard
{
  ...
  //MUST BE CALLED AT PROGRAM START!
	...
	static Hash ZOBRIST_PLAYER_HASH[2];
	...
	Loc last_loc; //The location of the last move made
