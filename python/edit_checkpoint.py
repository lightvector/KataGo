...
parser.add_argument(
    "-output-json-to",
    help=(
        "Output json contents to here, except for model parameters and optimizer state"
    ),
)
parser.add_argument(
    "-overwrite-checkpoint-from-json",
    help=(
        "Use this json contents to overwrite the apprpriate fields of the state dict of"
        " the checkpoint"
    ),
)
