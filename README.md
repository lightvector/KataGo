...
### OpenCL vs CUDA vs TensorRT vs RyzenAI vs Eigen
KataGo has five backends, OpenCL (GPU), CUDA (GPU), TensorRT (GPU), RyzenAI (AMD NPU), and Eigen (CPU). (On macOS there is also a Metal backend, most easily obtained via homebrew - see above.)
